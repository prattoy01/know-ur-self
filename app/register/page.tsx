            ...
            <div className="flex-1 bg-gray-50 flex items-center justify-center p-16">
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button
                            type="button"
                            className="w-full py-4 bg-white border-2 border-gray-200 rounded-xl text-base font-medium text-gray-800 transition-all duration-300 hover:border-purple-500 hover:bg-purple-50 flex items-center justify-center gap-3"
                        >
